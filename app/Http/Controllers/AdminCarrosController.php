<?php namespace App\Http\Controllers;
	...
	class AdminCarrosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Modelo","name"=>"modelo","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Placa","name"=>"placa","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Conductor Id","name"=>"conductor_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"conductor,id"];
			//$this->form[] = ["label"=>"Capacidad Pasajeros","name"=>"capacidad_pasajeros","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			# OLD END FORM
